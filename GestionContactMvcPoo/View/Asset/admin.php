    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="../../Controller/SuppressioModifierFavoris.php" method="POST">
                                    ...
                                    <button class="btn btn-success" name="term" value="<?php echo $cli['id'] ?>">Marquer Comme Favoris </button>
                                </form>
                            </td>
                ...
                <h4 class="alert alert-info"><a href="./ListFav.php">Voir Liste Des Contacts Favoris</a></h4>
            </div>
        </div>
    </div>
